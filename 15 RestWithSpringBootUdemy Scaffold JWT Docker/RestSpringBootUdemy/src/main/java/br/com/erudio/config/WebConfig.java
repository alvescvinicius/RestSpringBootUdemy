...
public class WebConfig implements WebMvcConfigurer {
	...
	private static MediaType MEDIA_TYPE_YML = MediaType.valueOf("application/x-yaml");
	...
	/*
	 * Habilita todos os recursos para qualquer Origen
	 */
	public void addCorsMapping(CorsRegistry registry) {
		registry.addMapping("/**")
		.allowedMethods("GET","POST","PUT", "DELETE", "OPTIONS", "HEAD", "TRACE", "CONNECT");
		// Especificar allowedMethods para permitir todos os metodos.
	}
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		configurer.favorPathExtension(false)
				...
				.mediaType("x-yaml", MEDIA_TYPE_YML); // Usando Yaml
