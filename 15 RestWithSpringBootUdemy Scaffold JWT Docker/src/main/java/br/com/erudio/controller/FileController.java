...
public class FileController {
	...
	public UploadFileResponseVO updaloadFile(@RequestParam("file") MultipartFile file) {
	...
	public List<UploadFileResponseVO> uploadMultipleFile(@RequestParam("files") MultipartFile[] files) {
		return Arrays.asList(files).stream().map(file -> updaloadFile(file)).collect(Collectors.toList());
	}
